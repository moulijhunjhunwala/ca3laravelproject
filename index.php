...
<html>
<head>
<title>WildLife Management System | Home Page</title>
...
<body>
			...
			<div class="header-banner">
				<div class="container">
					<div class="head-banner">
						<h3>Visit to a WildLife</h3>
						<p> A visit to a WildLife offers us an opportunity to see the wild animals.WildLife is a place where we can see different animals and birds at one place. It has great attraction particularly for the children. A visit to a WildLife gives us both information and entertainment. We come to learn about the rare species.</p>
					</div>
		...
		<!--header-->
			...
			<div class="content">
				<div class="welcome">
					<div class="container">
						<h2>welcome to WildLife planet</h2>
